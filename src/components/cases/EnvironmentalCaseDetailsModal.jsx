...
const EnvironmentalCaseDetailsModal = ({ isOpen, onClose, caseData }) => {
                  ...
                  <span
                    className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                      caseData.classification === "Confirmed"
                        ...
                        : caseData.classification === "Suspected"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-900 font-medium">
                  {caseData.environmental_factors}
                </p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600">
                ...
                <p className="text-gray-900">
                  {caseData.sample_collected ? "Yes" : "No"}
                </p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-600">
                ...
                <p className="text-gray-900">{caseData.personID}</p>
              </div>
            </div>
          </div>
...
export default EnvironmentalCaseDetailsModal;
